...
const SkillVideoReferencePanel = lazy(() =>
  import('../components/video/SkillVideoReferencePanel').then((module) => ({
    default: module.SkillVideoReferencePanel,
  })),
)
          ...
          <TabPanel id="watch" activeTab={activeTab}>
            <div className="animate-slideUp">
              <Suspense fallback={<div className="text-sm text-slate-400">{t('common.loading')}</div>}>
                <SkillVideoReferencePanel skillId={skill.id} lang={language} />
              </Suspense>
            </div>
          </TabPanel>
        </div>
