  ...
  const tracks: LearnTrack[] = [
    track(
      ...
      [
        ...
        { title: t('learn.tracks.beginner.steps.2.title'), body: t('learn.tracks.beginner.steps.2.body'), to: '/skills?domain=guard_retention' },        { title: t('learn.tracks.beginner.steps.5.title'), body: t('learn.tracks.beginner.steps.5.body'), to: '/defense' },
      ],
      'emerald',
      Target,
    ),
