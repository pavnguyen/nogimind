  ...
  const tracks: LearnTrack[] = [
    ...
    track(
      ...
      [
        ...
        { title: t('learn.tracks.deep.steps.4.title'), body: t('learn.tracks.deep.steps.4.body'), to: '/troubleshooters' },
        { title: t('learn.tracks.deep.steps.5.title'), body: t('learn.tracks.deep.steps.5.body'), to: '/concepts' },
      ],
      'cyan',
      Sparkles,
    ),
    track(
      ...
      [
        ...
        { title: t('learn.tracks.fix.steps.4.title'), body: t('learn.tracks.fix.steps.4.body'), to: '/skills' },
        { title: t('learn.tracks.fix.steps.5.title'), body: t('learn.tracks.fix.steps.5.body'), to: '/defense' },
      ],
      'amber',
      ShieldCheck,
    ),
    track(
      ...
      [
        ...
        { title: t('learn.tracks.build.steps.3.title'), body: t('learn.tracks.build.steps.3.body'), to: '/concepts' },
        { title: t('learn.tracks.build.steps.4.title'), body: t('learn.tracks.build.steps.4.body'), to: '/defense' },
      ],
      'emerald',
      Layers3,
    ),
