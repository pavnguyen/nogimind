...
export const priorityNoGiMicroDetailSystems: Record<string, MicroDetailSystem> = {
  'crucifix-control': {
    ...
    topFiveDetails: [
      md('cru-arm-trap', 'grip', lt('Trap arm bằng hai chân (Crucifix)', 'Trap arm with both legs (Crucifix)', 'Bloquer bras avec les deux jambes (Crucifix)'), lt('Kẹp cánh tay sát nách.', 'Pinch the arm tight to armpit.', 'Pincez le bras près de aisselle.'), 'near', 'close_in', ['legs', 'arms'], lt('Khi bắt đầu.', 'At the start.', 'Au début.'), lt('Tách arm khỏi thân.', 'Separates arm from torso.', 'Sépare le bras du torse.'), lt('Để lỏng chân.', 'Leaving legs loose.', 'Laisser jambes lâches.'), lt('Kẹp gối.', 'Pinch knees.', 'Pincez genoux.'), lt('Arm bị kẹt.', 'Arm is trapped.', 'Bras est piégé.'), safetyText)
    ],
    leftRightGuides: [],
    fastFinishPaths: [],
    troubleshootingTips: [],
  ...
  'deep-half-guard': {
    ...
    topFiveDetails: [
      md('dh-hide-arm', 'head', lt('Giấu tay dưới đùi (Deep Half)', 'Hide arm under thigh (Deep Half)', 'Cacher bras sous cuisse (Deep Half)'), lt('Tránh bị kimura.', 'Avoid kimura.', 'Éviter kimura.'), 'near', 'hide', ['arms', 'thighs'], lt('Khi chui vào.', 'When entering.', 'En entrant.'), lt('Bảo vệ tay.', 'Protects arm.', 'Protège bras.'), lt('Để lộ tay ngoài.', 'Leaving arm exposed outside.', 'Laisser arm exposé dehors.'), lt('Giấu tay.', 'Hide arm.', 'Cacher bras.'), lt('Tay an toàn.', 'Arm is safe.', 'Bras est sûr.'), safetyText)
    ],
    leftRightGuides: [],
    fastFinishPaths: [],
    troubleshootingTips: [],
  ...
  'wrestling-up-from-guard': {
    ...
    topFiveDetails: [
      md('wu-post', 'hand', lt('Post tay đứng lên (Wrestle-up)', 'Post hand to stand up (Wrestle-up)', 'Poster main pour se lever (Wrestle-up)'), lt('Dùng tay chống để nhấc hông.', 'Use hand post to lift hips.', 'Utiliser post main pour lever hanches.'), 'near', 'push_away', ['hands', 'hips'], lt('Khi có khoảng trống.', 'When there is space.', 'Quand il y a de l\'espace.'), lt('Tạo đà đứng.', 'Creates momentum to stand.', 'Crée élan pour se lever.'), lt('Cố đứng không post.', 'Trying to stand without posting.', 'Essayer se lever sans poster.'), lt('Post tay.', 'Post hand.', 'Poster main.'), lt('Hông nhấc lên.', 'Hips are lifted.', 'Hanches levées.'), safetyText)
    ],
    leftRightGuides: [],
    fastFinishPaths: [],
    troubleshootingTips: [],
  ...
  'front-headlock-system': {
    ...
    topFiveDetails: [
      md('fhs-snap', 'hand', lt('Snap down mạnh (FHL)', 'Strong snap down (FHL)', 'Snap down fort (FHL)'), lt('Giật đầu đối thủ.', 'Snap opponent head.', 'Casser posture tête adverse.'), 'both', 'pull_toward_you', ['hands', 'head'], lt('Khi họ đứng cao.', 'When they stand tall.', 'Quand ils sont grands.'), lt('Phá posture.', 'Breaks posture.', 'Casse posture.'), lt('Kéo bằng bắp tay.', 'Pulling with biceps only.', 'Tirer seulement avec biceps.'), lt('Snap mạnh.', 'Snap hard.', 'Snap fort.'), lt('Họ mất thăng bằng.', 'They lose balance.', 'Ils perdent équilibre.'), safetyText)
    ],
    leftRightGuides: [],
    fastFinishPaths: [],
    troubleshootingTips: [],
  ...
  'back-attack-system': {
    ...
    topFiveDetails: [
      md('bas-trap', 'hand', lt('Trap cánh tay (Back Attack)', 'Trap arm (Back Attack)', 'Bloquer bras (Back Attack)'), lt('Dùng chân khóa tay đối thủ.', 'Use leg to trap opponent arm.', 'Utiliser jambe pour bloquer bras adverse.'), 'near', 'close_in', ['legs', 'arms'], lt('Khi muốn RNC.', 'When going for RNC.', 'Quand chercher RNC.'), lt('Loại bỏ phòng thủ.', 'Removes defense.', 'Enlève défense.'), lt('Chỉ bóp cổ.', 'Only squeezing neck.', 'Seulement serrer cou.'), lt('Kẹp tay.', 'Trap arm.', 'Bloquer bras.'), lt('Tay bị khóa.', 'Arm is trapped.', 'Bras bloqué.'), safetyText)
    ],
    leftRightGuides: [],
    fastFinishPaths: [],
    troubleshootingTips: [],
  ...
  'leg-lock-defense': {
    ...
    topFiveDetails: [
      md('lld-hide', 'foot', lt('Giấu gót chân (Cơ bản)', 'Hide heel (Basics)', 'Cacher talon (Bases)'), lt('Che gót khỏi tay đối thủ.', 'Hide heel from opponent hands.', 'Cacher talon des mains adverses.'), 'inside', 'hide', ['heels'], lt('Khi bị bắt chân.', 'When leg is caught.', 'Quand jambe est prise.'), lt('Tránh heel hook.', 'Avoids heel hook.', 'Évite heel hook.'), lt('Để lộ gót.', 'Exposing heel.', 'Exposer talon.'), lt('Giấu gót.', 'Hide heel.', 'Cacher talon.'), lt('Gót an toàn.', 'Heel is safe.', 'Talon sûr.'), safetyText)
    ],
    leftRightGuides: [],
    fastFinishPaths: [],
    troubleshootingTips: [],
