...
export const armbarTriangleMicroDetailSystemEntries: Array<[string, MicroDetailSystem]> = [
  ['armbar-system', {
    ...
    troubleshootingTips: [
      { problem: lt('Elbow tuột ra.', 'The elbow slips out.', 'Le coude sort.'), quickFix: lt('Đưa hông sát vai và pinch gối trước extension.', 'Move hips to the shoulder and pinch knees before extension.', 'Hanches vers épaule et genoux serrés.'), cue: lt('Hông lên vai.', 'Hips to shoulder.', 'Hanches épaule.') },
      { problem: lt('Bị stack.', 'You get stacked.', 'Vous êtes stacké.'), quickFix: lt('Chân thứ hai đè chest/head line và quay angle.', 'Use the second leg across chest/head line and turn the angle.', 'Deuxième jambe bloque posture et angle.'), cue: lt('Posture bị chặn.', 'Posture blocked.', 'Posture bloquée.') },
      { problem: lt('Finish thành crank đau.', 'Finish becomes painful crank.', 'Le finish devient crank.'), quickFix: lt('Đọc thumb line và tăng extension chậm.', 'Read thumb line and extend slowly.', 'Lire le pouce et extension lente.'), cue: lt('Ngón cái trước.', 'Thumb first.', 'Pouce d’abord.') },
      { problem: lt('Defender xoay thumb xuống.', 'Defender rotates thumb down.', 'Défenseur tourne pouce bas.'), quickFix: lt('Hai tay giữ wrist và đưa thumb về ceiling.', 'Control wrist with both hands and return thumb to ceiling.', 'Deux mains sur poignet, pouce plafond.'), cue: lt('Cổ tay của mình.', 'Own wrist.', 'Contrôle poignet.') },
      { problem: lt('Mất vị trí khi ngả.', 'You lose position when sitting back.', 'Vous perdez position.'), quickFix: lt('Gối sát đầu trước, rồi mới ngả.', 'Knee beside head first, then sit back.', 'Genou près tête avant de partir.'), cue: lt('Gối trước.', 'Knee first.', 'Genou d’abord.') },
    ],
  ...
  ['triangle-system', {
    ...
    fastFinishPaths: [
      path('triangle-fast-path', lt('Đường triangle sạch', 'Clean triangle path', 'Chemin triangle propre'), [
        ...
        { id: '4', order: 4, instruction: lt('Giấu foot.', 'Hide foot.', 'Cacher pied.'), keyBodyPart: 'feet', commonMistake: lt('Chân lộ.', 'Foot exposed.', 'Pied exposé.') },
    ...
    troubleshootingTips: [
      { problem: lt('Triangle không siết.', 'Triangle does not squeeze.', 'Triangle ne serre pas.'), quickFix: lt('Cắt angle về trapped-arm side.', 'Cut angle toward trapped-arm side.', 'Couper côté bras piégé.'), cue: lt('Góc trước.', 'Angle first.', 'Angle d’abord.') },
      { problem: lt('Bị stack.', 'You get stacked.', 'Vous êtes stacké.'), quickFix: lt('Kéo posture xuống và hip scoot ra angle.', 'Pull posture down and hip scoot to angle.', 'Posture basse et hanches dehors.'), cue: lt('Posture xuống.', 'Posture down.', 'Posture basse.') },
      { problem: lt('Foot bị peel.', 'Foot gets peeled.', 'Pied peelé.'), quickFix: lt('Giấu foot sau gối trước khi squeeze.', 'Hide the foot behind the knee before squeezing.', 'Cacher pied derrière genou.'), cue: lt('Giấu chân.', 'Hide foot.', 'Cacher pied.') },
      { problem: lt('Thành neck crank.', 'It becomes a neck crank.', 'Ça devient crank.'), quickFix: lt('Đóng gối sau angle, không kéo đầu mạnh.', 'Close knees after angle; do not yank the head.', 'Genoux après angle, pas tirer tête.'), cue: lt('Gối, không phải cổ.', 'Knees, not neck.', 'Genoux, pas cou.') },
      { problem: lt('Hai vai lọt vào trong.', 'Both shoulders get inside.', 'Deux épaules dedans.'), quickFix: lt('Đẩy một shoulder ra ngoài bằng thigh/knee line.', 'Push one shoulder out with thigh/knee line.', 'Sortir une épaule avec cuisse/genou.'), cue: lt('Một vai ra ngoài.', 'One shoulder out.', 'Une épaule dehors.') },
    ],
