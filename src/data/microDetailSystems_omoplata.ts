...
export const omoplataMicroDetailSystemEntry: [string, MicroDetailSystem] = ['omoplata-system', {
  ...
  troubleshootingTips: [
    { problem: lt('Defender roll thoát.', 'Defender rolls out.', 'Défenseur roll out.'), quickFix: lt('Giữ wrist và theo sweep thay vì bám shoulder lock.', 'Keep wrist and follow the sweep instead of clinging to shoulder lock.', 'Garder poignet et suivre sweep.'), cue: lt('Theo roll.', 'Follow the roll.', 'Suivre roll.') },
    { problem: lt('Không ngồi dậy được.', 'Cannot sit up.', 'Impossible de se redresser.'), quickFix: lt('Scoot hông ra ngoài trước, rồi post tay.', 'Scoot hips outside first, then post the hand.', 'Hanches dehors puis post main.'), cue: lt('Hông ra.', 'Hips out.', 'Hanches dehors.') },
    { problem: lt('Shoulder pressure đau nhưng không tap.', 'Shoulder pressure hurts but no tap.', 'Pression douloureuse sans tap.'), quickFix: lt('Dừng giật; dựng chest và đưa hips tiến chậm.', 'Stop jerking; sit tall and move hips forward slowly.', 'Stop coup; posture haute et hanches lentes.'), cue: lt('Hông chậm.', 'Slow hips.', 'Hanches lentes.') },
    { problem: lt('Defender posture lên.', 'Defender postures up.', 'Défenseur posture.'), quickFix: lt('Shin cao hơn shoulder line và giữ wrist xuống.', 'Raise shin above shoulder line and keep wrist down.', 'Tibia haut et poignet bas.'), cue: lt('Shin cao.', 'Shin high.', 'Tibia haut.') },
    { problem: lt('Bị stack lại.', 'You get stacked back.', 'Vous êtes stacké.'), quickFix: lt('Angle ra ngoài thay vì kéo thẳng.', 'Angle outside instead of pulling straight.', 'Angle dehors, pas tirer droit.'), cue: lt('Góc ngoài.', 'Outside angle.', 'Angle dehors.') },
  ],
