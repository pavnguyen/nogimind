...
export const masteryStages: MasteryStage[] = [
  {
    id: 'survive',
    order: 1,
    title: lt('Sống sót', 'Survive', 'Survivre'),
  ...
  },
  {
    id: 'escape',
    order: 2,
    title: lt('Thoát hiểm', 'Escape', 'Sortir'),
  ...
  },
  {
    id: 'retain_guard',
    order: 3,
    title: lt('Giữ guard', 'Retain Guard', 'Retenir la garde'),
  ...
  },
  {
    id: 'build_entries',
    order: 4,
    title: lt('Xây entry', 'Build Entries', 'Construire entrées'),
  ...
  },
  {
    id: 'pass_and_pin',
    order: 5,
    title: lt('Pass và pin', 'Pass and Pin', 'Passer et pinner'),
  ...
  },
  {
    id: 'create_dilemmas',
    order: 6,
    title: lt('Tạo thế khó', 'Create Dilemmas', 'Créer dilemmes'),
  ...
  },
  {
    id: 'finish_safely',
    order: 7,
    title: lt('Finish an toàn', 'Finish Safely', 'Finir en sécurité'),
  ...
  },
  {
    id: 'chain_systems',
    order: 8,
    title: lt('Chuỗi hệ thống', 'Chain Systems', 'Chaîner systèmes'),
  ...
  },
  {
    ...
    order: 9,
    title: lt('Thích nghi với đối thủ', 'Adapt to Opponents', 'S’adapter'),
  ...
  },
  {
    ...
    order: 10,
    title: lt('Tư duy black belt', 'Black Belt Mindset', 'Mentalité black belt'),
