...
const quickCardFor = (seedValue: SkillSeed, microDetailSystem?: MicroDetailSystem): QuickCard | undefined => {
  ...
  return {
    ...
    ifItFails: firstFastPath
      ...
      : lt('Reset vị trí và quay lại nhánh tiếp theo.', 'Reset position and return to the next branch.', 'Réinitialisez la position et revenez à la branche suivante.'),
...
const drillsFor = (seedValue: SkillSeed): Drill[] => [
  ...
  {
    name: lt('Rounds nhận diện cue', 'Cue recognition rounds', 'Rounds de reconnaissance des cues'),
  ...
  {
    name: lt('Theo dõi entry trong live', 'Live entry tracking', 'Suivi des entrées en live'),
